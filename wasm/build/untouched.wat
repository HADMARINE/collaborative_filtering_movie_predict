(module
 ...
 (data (i32.const 512) "\08\00\00\00\01\00\00\00\06\00\00\00\08\00\00\00\01\00\00\00\00\00\00\00")
 (data (i32.const 544) "\08\00\00\00\01\00\00\00\06\00\00\00\08\00\00\00\02\00\00\00\00\00\00\00")
 (data (i32.const 576) "\07\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\000\1a\82\00\00\00\00\000A\82\00\00\00\00\00\"A\00\00\00\00\00\00 \00\00\00\00\00\00\00")
 (table $0 3 funcref)
 ...
 (func $~lib/map/Map<~lib/string/String,~lib/map/Map<~lib/string/String,f64>>#constructor (param $0 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 24
 ...
 (func $start:assembly/functions/transpose
  i32.const 0
  call $~lib/map/Map<~lib/string/String,~lib/map/Map<~lib/string/String,f64>>#constructor
  global.set $assembly/functions/transpose/transposedData
 )
 (func $start:assembly/index
  call $start:assembly/functions/transpose
 )
 ...
 (func $~lib/map/Map<~lib/string/String,~lib/map/Map<~lib/string/String,f64>>#keys (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $assembly/functions/transpose/transpose (param $0 i32) (result i32)
  ...
  global.get $assembly/functions/transpose/data
  call $~lib/map/Map<~lib/string/String,~lib/map/Map<~lib/string/String,f64>>#keys
  local.tee $1
  i32.const 560
  call $~lib/array/Array<~lib/string/String>#forEach
  global.get $assembly/functions/transpose/transposedData
 ...
 (func $~lib/map/Map<~lib/string/String,~lib/map/Map<~lib/string/String,f64>>#__visit_impl (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/function/Function<%28~lib/string/String%2Ci32%2C~lib/array/Array<~lib/string/String>%29=>void>#__visit_impl (param $0 i32) (param $1 i32)
  local.get $0
  i32.load offset=4
  local.get $1
  call $~lib/rt/pure/__visit
  ...
  block $switch$1$default
   block $switch$1$case$8
    block $switch$1$case$7
     ...
     local.get $0
     local.get $1
     call $~lib/map/Map<~lib/string/String,~lib/map/Map<~lib/string/String,f64>>#__visit_impl
     return
    end
    local.get $0
    local.get $1
   ...
   local.get $0
   local.get $1
   call $~lib/function/Function<%28~lib/string/String%2Ci32%2C~lib/array/Array<~lib/string/String>%29=>void>#__visit_impl
   return
  end
  unreachable
 )
